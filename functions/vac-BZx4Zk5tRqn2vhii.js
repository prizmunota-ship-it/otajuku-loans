...
function mapq(a){var s=(a.propaddr||a.paddr||'');s=s.replace(/[０-９]/g,function(d){return String.fromCharCode(d.charCodeAt(0)-0xFEE0);}).replace(/[−ー―‐]/g,'-');return encodeURIComponent(s);}
